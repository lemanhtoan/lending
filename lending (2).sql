...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th2 27, 2018 lúc 07:32 AM
...
--
-- Cơ sở dữ liệu: `lending`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `admin_ip`
--
...
--
-- Đang đổ dữ liệu cho bảng `admin_ip`
--
...
(1, 13, '11.00', 'BTC', 12, '3.00', '270.00', '61.00', '170.00', '2017-11-07 07:44:58', '2018-11-07 07:44:58', 0, '2017-10-17 08:35:06', '2017-11-07 07:44:58'),
...
(5, 32, 3, 0, '2017-11-07 08:03:15', '2017-11-07 08:03:15');
...
--
-- Cấu trúc bảng cho bảng `temp_summary`
--
...
(32, 'test', 'test@gmail.com', '$2y$10$aoKWL585E0zyPpMSu8HQ/.mhPbeDZjdxliedAHex6zSKgC0RYDfmO', 3, 0, 0, 1, NULL, '2017-10-21 01:44:11', '2017-11-07 08:02:55', NULL, 1, 2, 'USDT'),
...
--
-- Cấu trúc bảng cho bảng `user_total`
--
...
--
-- AUTO_INCREMENT cho bảng `admin_ip`
--
ALTER TABLE `admin_ip`
...
ALTER TABLE `tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT cho bảng `temp_summary`
--
ALTER TABLE `temp_summary`
...
ALTER TABLE `user_bank`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT cho bảng `user_id`
--
ALTER TABLE `user_id`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT cho bảng `user_summary`
--
ALTER TABLE `user_summary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT cho bảng `user_total`
--
ALTER TABLE `user_total`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
